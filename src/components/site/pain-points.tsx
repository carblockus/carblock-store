...
export function PainPoints() {
  return (
    <section className="bg-black border-y border-[var(--border)] py-6 md:py-8">
      <div className="container-x">
        <div className="relative w-full max-w-7xl mx-auto rounded-lg overflow-hidden border border-[var(--border)] shadow-2xl">
          <Image
